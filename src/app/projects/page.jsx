    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="projects" className="py-16 px-4 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">My FrontendProjects</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Description of your third project and its key features.</p>
                <div className="flex space-x-2">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">project 7.</h3>
                <p className="text-gray-600 mb-4">its a single page website created with React, Tailwind </p>
                <div className="flex space-x-2">
                  <span className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded">React</span>
                  <span className="bg-green-100 text-green-800 text-sm px-3 py-1 rounded">Tailwind</span>
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">project 8.</h3>
                <p className="text-gray-600 mb-4">its a single page website created with React, Tailwind </p>
                <div className="flex space-x-2">
                  <span className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded">React</span>
                  <span className="bg-green-100 text-green-800 text-sm px-3 py-1 rounded">Tailwind</span>
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">project 9.</h3>
                <p className="text-gray-600 mb-4">its a single page website created with React, Tailwind </p>
                <div className="flex space-x-2">
                  <span className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded">React</span>
                  <span className="bg-green-100 text-green-800 text-sm px-3 py-1 rounded">Tailwind</span>
